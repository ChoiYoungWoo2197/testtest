...
public class RISKM005_EXCEL extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		for(int i = 0; i< list.size();i++){
			...
			setText(cell,(String)map.get("urcCtrGbn"));
			
			cell = getCell(sheet, 3+i, 1);
			setText(cell,(String)map.get("urc1lvCod"));
			
			cell = getCell(sheet, 3+i, 2);
			setText(cell,(String)map.get("urc1lvNam"));
			
			cell = getCell(sheet, 3+i, 3);
			setText(cell,(String)map.get("urc2lvCod"));
			
			cell = getCell(sheet, 3+i, 4);
			setText(cell,(String)map.get("urc2lvNam"));
			
			cell = getCell(sheet, 3+i, 5);
			setText(cell,(String)map.get("urc2lvDtl"));
			
			cell = getCell(sheet, 3+i, 6);
			setText(cell,(String)map.get("urc3lvCod"));
			
			cell = getCell(sheet, 3+i, 7);
			setText(cell,(String)map.get("urc3lvNam"));
			
			cell = getCell(sheet, 3+i, 8);
			setText(cell,(String)map.get("urc3lvDtl"));
			
			cell = getCell(sheet, 3+i, 9);
			setText(cell,(String)map.get("urc1ldYn"));
			
			cell = getCell(sheet, 3+i, 10);
			setText(cell,(String)map.get("urc2ldYn"));
			
			cell = getCell(sheet, 3+i, 11);
			setText(cell,(String)map.get("urc3ldYn"));
		}
	}
