...
public class COMPS003_default extends AbstractExcelView {
    @Override
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        for(int i = 0; i< listComps.size();i++) {
            ...
            if( !String.valueOf(mapRows.get("ucmCtrCod")).trim().equals(strCtrCod) ){
                ...
                intRow = 4;
                String strTitles[] = {"No", "분야", "No", "항목", "상세내용", "주요 확인사항", "설명", "code"};
            ...
            listCellInfo.add(String.valueOf(mapRows.get("ucmGolNo")).trim());
