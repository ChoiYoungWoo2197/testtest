...
<script type="text/x-template" id="file-manager-template">
    ...
    <div class="file-manager-vm">
        <div class="border-b pb-3 mb-3">
            <div class="input-group mr-3 mb-2">
                <div class="custom-file">
                    <input ref="fileUploader" v-on:change="addFiles($event)" v-on:click="resetFileUploader" multiple type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                    <label class="custom-file-label" for="inputGroupFile01" data-browse="찾기">파일을 선택하세요.</label>
                </div>
            </div>
            <p class="text-gray-600">※ Ctrl 키를 누른 상태에서 파일을 클릭하면 한번에 여러개의 파일을 선택할 수 있습니다.</p>
        </div>
        <div class="mb-3 border-b pb-3">
            <p class="text-gray-700 mb-2"><i class="fa fa-minus" aria-hidden="true"></i> 저장된 파일</p>
        ...
        <div class="mb-3 border-b pb-3">
            <p class="text-gray-700 mb-2"><i class="fa fa-minus" aria-hidden="true"></i> 추가될 파일</p>
        ...
        <div>
            <p class="text-gray-700 mb-2"><i class="fa fa-minus" aria-hidden="true"></i> 삭제될 파일</p>
            ...
            <ul v-else>
                <li v-for="file in deletedFiles">
                    {{ file.umf_con_fnm }}
                    <span class="cursor-pointer ml-3 delete-btn" v-on:click="cancelDeleteFile(file)">삭제</span>
                </li>
            </ul>
        </div>
    </div>
