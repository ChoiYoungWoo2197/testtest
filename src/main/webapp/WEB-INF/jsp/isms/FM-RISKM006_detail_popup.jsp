...
function serachList(){
	...
	$("#gridTb").jqGrid({
		url:"${pageContext.request.contextPath}/riskm/FM-RISKM006_rst_list.do",
		postData : formData,
		datatype : "json",
		mtype : "post",
		colNames:['구분', '항목','위험도','진단결과'],
		colModel:[
			{name:'urvRskDiv',	index:'urvRskDiv',	width: 150,	align:'left',	hidden:false},
			{name:'urvRskItm',	index:'urvRskItm',	width: 510,	align:'left',	hidden:false},
			{name:'urvRskImp',	index:'urvRskImp',	width: 70,	align:'center',	hidden:false},
		  	{name:'urrRskRst',	index:'urrRskRst',	width: 80,	align:'center',	hidden:false}
		],
...
<body>
	<form id="searchForm" method="post" name="searchForm">
		...
		<input type="hidden" name="uarAssCod" id="uarAssCod" value='<c:out value="${uarAssCod}"/>'/>
	</form>
</body>
</html>