...
<script type="text/javascript">
    ...
    function initChart(){
        ...
        $(".chartContainer").hide();
        if(val==0){
            progressChartMsit(1, "getStatisticsMsitPart1.do", val, params);
        }else if(val==1) {
            progressChartMsit(2, "getStatisticsMsitPart2.do", val, params);
        }
    }
    function downPDF(){
        window.open("","downPDF");
        ...
        $("#downPDF form").append("<input type=\"hidden\" name=\"type\" value=\"msit\" />");
...
<div class="tabArea" style="margin-bottom: 10px;">
    <ul id="listTab1" class="list2Tab">
        <li class="sel"><a href="javascript:;">분류별 준수율</a></li>
...
<div class="chartContainer contents" id="chartContainer1">
    <ul class="choice_section not_pdf">
        <li><label><input type="checkbox" class="chkDisplay" target="chart1_1" kind="crt" checked>분류별 준수율 - 차트</label></li>
        <li><label><input type="checkbox" class="chkDisplay" target="chart1_1" kind="tbl" checked>분류별 준수율 - 표</label></li>
        <li><label><input type="checkbox" class="chkDisplay" target="chart1_2" kind="crt" checked>연도별 평가 결과 비교 - 차트</label></li>
        <li><label><input type="checkbox" class="chkDisplay" target="chart1_2" kind="tbl" checked>연도별 평가 결과 비교 - 표</label></li>
    </ul>
    <div class="title chart1_1">분류별 준수율</div>
    ...
    <div class="title chart1_2">연도별 평가 결과 비교</div>
