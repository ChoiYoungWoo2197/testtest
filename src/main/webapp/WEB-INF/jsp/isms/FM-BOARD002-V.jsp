...
<c:if test="${authKey eq 'A' || usrKey eq vo.ubm_rgt_id}">
	...
	function fn_egov_delete() {
		if (confirm("삭제하시겠습니까?")) {
			document.viewForm.action = "FM-BOARD002_D.do";
	...
	function fn_egov_selectList() {
		document.viewForm.action = "/board/FM-BOARD002.do";
		document.viewForm.submit();
	}
	...
	function fn_egov_regist_Restde() {
		document.viewForm.action = "FM-BOARD002_RW.do";
		document.viewForm.submit();
	}
</script>
<div>
			...
			<div class="talbeArea">
				<table summary="공지사항 제목과 작성자, 작성일 등의 정보를 설명하고있습니다.">
					...
					<tbody>
						<tr>
							<th>제목</th>
							<td class="listTitle last"><c:out value="${vo.ubm_brd_tle}" /></td>
							<th>분류</th>
							<td class="listTitle last"><c:out value="${vo.ubm_cat_nam}" /></td>
						</tr>
						<tr class="last">
							<th>작성자</th>
