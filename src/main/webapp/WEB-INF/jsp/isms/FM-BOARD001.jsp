...
<script type="text/javascript">
	...
	function fn_egov_pageview(pageNo) {
		...
		document.listForm.action = "FM-BOARD001.do";
		document.listForm.submit();
	}

	function fn_egov_regist_Restde() {
		document.listForm.action = "FM-BOARD001_RW.do";
		document.listForm.submit();
	}

	function fn_egov_select(id) {
		document.listForm.selectedId.value = id;
		document.listForm.action = "FM-BOARD001_V.do";
		document.listForm.submit();
	}
</script>
</head>
<body>
		...
		<form name="listForm" action="FM-BOARD001.do" method="post">
		<input type="hidden" name="selectedId" />
		<input type="hidden" id="rstCod" value="${rstCod}" />
		<div class="search">
			<div class="defalt">
				<fieldset class="searchForm">
					...
					<button href="#none" class="btnSearch" onclick="fn_egov_search_Restde(); return false;">검색</button>
				</fieldset>
			</div>
		</div>
		<div class="contents">
