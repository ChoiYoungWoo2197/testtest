...
function excelDownload(){
	...
	document.excelDownloadForm.action = "${pageContext.request.contextPath}/excel/FM-RISKM003_REPORT_DOWN.do";
	...
	<div id="wrap" class="pop">
		...
		<article class="cont" id="content-box">
			...
			<div class="centerBtnArea">
				...
				<ul class="btnList">
					<li><button type="button" class="btnStrong" onclick="excelDownload();"><span class="icoDown"></span>위험조치계획서 다운로드</button>
				</ul>
			</div>
		</article>
	</div>
