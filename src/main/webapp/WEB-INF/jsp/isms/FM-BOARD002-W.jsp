...
function fn_egov_selectList() {
   	document.detailForm.action = "FM-BOARD002.do";
   	document.detailForm.submit();
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.detailForm.action = "FM-BOARD002_D.do";
   	document.detailForm.submit();
}
...
function fn_egov_save() {
	...
	if(CKEDITOR.instances.ubm_brd_cts.getData() == ''){
   	...
   	frm.action = "<c:url value="${registerFlag == '등록' ? 'FM-BOARD002_W.do' : 'FM-BOARD002_U.do'}"/>";
	frm.submit();
}
			...
			<table summary="게시판 제목과 노출여부, 권한 등의 정보를 설정할 수 있습니다.">
				...
				<tbody>
					<tr>
						...
						<th><label for="ubm_cat_cod">분류</label></th>
						<td class="last">
							<sb:select name="ubm_cat_cod" type="A" code="CATEGORY" allText="선택" value="${vo.ubm_cat_cod}"/>
						</td>
					</tr>
					<tr class="last">
						<th>권한 설정</th>
