...
$(window).load(function() {
	...
	$("#listTab1 li").click(function() {
		...
		if (val) {
			progressBarChart(1, "getWorkMonthStatistics.do", val, true, null, true);
		}
		else {
			progressLineChart(1, "getWorkMonthStatistics.do", val, true);
		}
	});
	$("#listTab2 li").click(function() {
		var val = clickListTab(this);
		progressBarChart(2, "getWorkServiceStatistics.do", val, false, { month: chartCode2 });
	});
	...
	<div class="chartContainer" id="chartContainer1">
		<div class="tabArea" style="margin-bottom: 10px;">
		    <ul id="listTab1" class="list2Tab">
		        <li class="sel"><a href="javascript:;">기간별 진행현황 (건)</a></li>
		        <li><a href="javascript:;">기간별 진행현황 (%)</a></li>
		    </ul>
		</div>
		...
		<div class="comment">
			※ 기간을 클릭하면 해당 기간내의 서비스 정보를 확인 할 수 있습니다.
		</div>
	</div>
	...
	<div class="chartContainer" id="chartContainer2" style="display: none">
		<div class="tabArea" style="margin-bottom: 10px;">
		    <ul id="listTab2" class="list2Tab">
		        <li class="sel"><a href="javascript:;"><span class="chartTitle2"></span> 서비스별 진행현황 (건)</a></li>
		        <li><a href="javascript:;"><span class="chartTitle2"></span> 서비스별 진행현황 (%)</a></li>
		    </ul>
		</div>
