...
function dataTipFunc000(seriesId, seriesName, index, xName, yName, data, values)
{
	var str = values[1] +"<br/>"+ seriesName +" : " + values[0] + yName +"<br/>합계 : "+ getSum(data) + yName
	return str;
}
...
//예) <Column3DChart showDataTips="true" itemClickJsFunction="chartItemClickHandler">
//
//파라메터 설명
//seriesId : layout XML에서 부여한 series의 id가 있을 경우, 해당 id를 보내줍니다.
...
{
	chUrl = "${pageContext.request.contextPath}/state/FM-STATE006.do";
	parent.$('#serviceName').val(values[1]);
	parent.$('#toBoard').attr('action',chUrl).submit();
}
...
<body style="margin: 0;">
	<div id="content">
		<!-- 차트가 삽입될 DIV -->
		<div id="chartHolder" style="width:270px; height:210px;margin: -15px -10px -5px;">
		</div>
	</div>
</body>
</html>