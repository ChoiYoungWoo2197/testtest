...
function excelUpload() {
	...
	var strUrl = "${pageContext.request.contextPath}/inspt/FM-INSPT004_excelNew_Upload.do"
				...
				<div class="contents">
					<div class="talbeArea">
						<table summary="엑셀 다운로드">
							...
							<caption>보호활동 엑셀 업로드</caption>
							<tbody>
		  						<tr>
			                		<th class="listTitle">컴플라이언스</th>
			                        <td class="fontLeft last">
										<select class="selectBox" id="standard" name="standard" style="width:auto">
											<option value="">컴플라이언스 선택</option>
