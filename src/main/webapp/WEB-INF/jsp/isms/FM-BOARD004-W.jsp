...
function fn_egov_selectList() {
   	document.detailForm.action = "FM-BOARD004.do";
...
function copyToFAQ() {
	frm = document.detailForm;
   	frm.action = "FM-BOARD004_copyToFAQ.do";
	frm.submit();
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.detailForm.action = "FM-BOARD004_D.do";
   	document.detailForm.submit();
}
...
function fn_egov_save() {
	...
	if(CKEDITOR.instances.ubm_brd_cts.getData() == ''){
   	...
   	frm.action = "<c:url value="${registerFlag == '등록' ? 'FM-BOARD004_W.do' : 'FM-BOARD004_U.do'}"/>";
	frm.submit();
}
...
function addFileUpdate(seq){
	frm = document.detailForm;
   	frm.action = "FM-BOARD004_U.do";
	frm.submit();
}

function copyToFAQ() {
	frm = document.detailForm;
	frm.ubm_brd_key.value = ${vo.ubm_brd_key};
   	frm.action = "FM-BOARD004_copyToFAQ.do";
	frm.submit();
}
</script>
...
<body>
	...
	<form:form commandName="vo" name="detailForm" enctype="multipart/form-data">
		...
		<div class="talbeArea">
           <table summary="QNA 게시판의 제목과 작성자, 작성일 등의 정보를 설명하고 있습니다.">
               <colgroup>
                   <col width="15%">
                   <col width="*">
                   <col width="15%">
               ...
               <tbody>
                   <tr>
                       ...
                       <td class="listTitle last" colspan="3"><form:input path="ubm_brd_tle" maxlength="80" size="80" class="inputText" id="ubm_brd_tle"/>
	...
	<th scope="row">상세내용</th>
        ...
        <div class="bottomBtnArea">
            <ul class="btnList">
                ...
                <c:if test="${registerFlag == '수정'}">
                <li>
                    <button class="btnStrong" onclick="fn_egov_save();"><span class="icoRepair"></span>답변작성 완료</button>
                </li>
                <li>
					<button class="btnStrong" onclick="copyToFAQ();">
						<span class="icoList"></span>FAQ 이관
					</button>
				</li>
                </c:if>
                <li>
