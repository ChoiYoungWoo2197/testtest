...
<c:if test="${authKey eq 'A' || usrKey eq vo.ubm_rgt_id}">
	...
	function fn_egov_delete() {
		if (confirm("삭제하시겠습니까?")) {
			document.viewForm.action = "FM-BOARD001_D.do";
	...
	function fn_egov_selectList() {
		document.viewForm.action = "/board/FM-BOARD001.do";
		document.viewForm.submit();
	}
	...
	function fn_egov_regist_Restde() {
		document.viewForm.action = "FM-BOARD001_RW.do";
		document.viewForm.submit();
	}
</script>
<div>
		...
		<div class="contents">
			<div class="talbeArea">
				<table summary="공지게시판 제목과 작성자, 작성일 등의 정보를 설명하고있습니다.">
					<colgroup>
						<col width="15%">
						<col width="*">
						<col width="15%">
