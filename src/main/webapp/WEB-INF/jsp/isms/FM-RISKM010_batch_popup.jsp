...
$(document).ready(function() {
	...
	$("#btnSubmit").click(function() {
		...
		if (confirm("담당자에게 대책수립을 할당 하시겠습니까?")) {
			$.post("${pageContext.request.contextPath}/riskm/FM-RISKM010_batchJob.do",
				{ uagSvrCod: $("#uagSvrCod").val(), doa: $("#doa").val(), ursReqMdh: $("#ursReqMdh").val() }, function(data) {
					if (data.result == "true") {
...
<body>
	...
	<input type="hidden" id="uagSvrCod" name="uagSvrCod" value="${uagSvrCod}"/>
	...
	<div id="wrap" class="pop">
		...
		<article class="cont" id="content-box">
				...
				<div class="contents">
					<div class="talbeArea">
		        		<table summary="당자 대책수립 일괄 할당">
							...
							<tbody>
								<tr>
									<th scope="row" class="listTitle"><label for="urgSvcCod">서비스명</label></th>
									<td class="fontLeft last">
										<input type="text" class="inputText wdShort" value="${uagSvrNam}" readonly="readonly"/>
									</td>
								</tr>
								<tr>
			...
			<div class="centerBtnArea bottomBtnArea">
				...
				<ul class="btnList">
					<li><button type="button" class="btnStrong" id="btnSubmit"><span class="icoSave"></span>대책수립 일괄 할당</button></li>
				</ul>
			</div>
		</article>
	</div>
