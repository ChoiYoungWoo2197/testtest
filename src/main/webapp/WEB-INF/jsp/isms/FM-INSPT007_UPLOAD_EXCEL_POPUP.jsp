...
<head>
	...
	<script  type="text/javascript">
		...
		function excelUpload() {
			...
			var uploadFilePath = $("[name='excelFile']").val();
			...
			var strUrl = "${pageContext.request.contextPath}/inspt/FM-INSPT007_UPLOAD_EXCEL.do";
...
<form id="excelUploadForm" name="excelUploadForm" method="post" enctype="multipart/form-data">
	...
	<div id="wrap" class="pop">
		<header>
			...
			<h1>Self-Audit 작업현황 엑셀업로드</h1>
		</header>
		<article class="cont" id="content-box">
			<div class="cont_container" style="padding-top: 10px;">
				<div class="contents">
					<p class="notice-text">동일한 점검항목의 결과를 모두 수정해야 정상적으로 반영됩니다.</p>
					<div class="talbeArea">
						<table summary="엑셀 다운로드">
							...
							<caption>Self-Audit 작업현황 엑셀업로드</caption>
							<tbody>
							<tr>
